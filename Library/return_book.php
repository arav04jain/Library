<?php
    ...
    $b=mysqli_query($mysqli,"DELETE FROM `borrow` WHERE book_id=".$a.";");
    $b=mysqli_query($mysqli,"UPDATE `book` SET `available`='Available' WHERE book_id=".$a.";");
    $texttd="Book Succesfully Returned";
...
<body style="background-color: #FFFFE0; text-align: center;">
    ...
    <div style="border-color: white; border: 2px 2px 2x 2px; text-align: center">
        <br><br><br><br>
        <h1 style="color: #5C4033;">Return Book</h1>
        <br>
        <div style="text-align: center;" class="d-flex justify-content-center div-to-align">
            <input style="text-align: center;" class="form-control" placeholder="Book ID" size="25" type="number"
                id="fn" maxlength="9999999" name="book_idd">
        </div>
        <br>
        <br>
    ...
    <button type="submit" class="btn "
        style="color: #FFFFE0; background-color: #5C4033; font-size: 150%; ">Return</button>
        <br><br>
